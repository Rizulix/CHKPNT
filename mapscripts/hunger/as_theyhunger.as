...
void MapInit()
{
	...
	CHKPNT::Register();
	point_checkpoint::g_flDelayBeforeStart = 1.5;
	point_checkpoint::g_szEntityModel = 'models/hunger/umbrella.mdl';
	point_checkpoint::g_szPortalSprite = 'sprites/null.spr';
	point_checkpoint::g_szActivationSound = 'hunger/checkpointjingle.mp3';
	point_checkpoint::g_szPortalCreationSound = 'common/null.wav';
	point_checkpoint::g_szPortalShutdownSound = 'common/null.wav';
	point_checkpoint::g_szPlayerRespawnSound = 'debris/beamstart15.wav';
	point_checkpoint::g_vecMins = Vector(-64, -64, -36);
	point_checkpoint::g_vecMaxs = Vector(64, 64, 36);
